...
### F3 — Konfigurationsquelle → manuelle Eingabe in der Options-Seite *(2026-08-16)*
...
### F1 — Betriebsmodus → Picker als Default, `login_hint` als Opt-in *(2026-08-16)*
...
### F2 — Notausgang → globaler Toggle in der Options-Seite *(2026-08-16)*
...
### F4 — Repository-Name → `ms-account-picker` *(2026-08-16)*
...
### F6 — E2E-Strategie → Dummy-Authorize-Endpunkt *(2026-08-16)*
...
### F7 — Endpunkt-Aliase → nicht abdecken *(2026-08-16)*
