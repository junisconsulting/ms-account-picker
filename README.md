...
**Status: Phase 2 — implemented, not yet rolled out.** Rule builder, service worker and the configuration UI are in place; 29 unit tests and 38 end-to-end checks pass. Still open: the store item that produces a stable extension ID, and a full run of the manual verification matrix.
